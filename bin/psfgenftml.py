...
def doit(args):
    ...
    if test.lower().startswith("allchars"):
        ...
        ftml.addToTest(0xFDF2, "\uFDF2", comment = "Rule 1")
        ftml.closeTest()
        ftml.addToTest(None, "\u0641\u0644\u0644\u0647", label = "f-l-l-h", comment = "shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u0651\u0670\u0647", label = "a-l-l-s-da-hf", comment = "Rule 2 (daggeralef)")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u0670\u0651\u0647", label = "a-l-l-da-s-hf")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u0651\u0670\u06C1", label = "a-l-l-s-da-hgf")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u0670\u0651\u06C1", label = "a-l-l-da-s-hgf")
        ftml.closeTest()

        ftml.addToTest(None, "\u0627\u0644\u0644\u0651\u064E\u0647", label = "a-l-l-s-f-hf", comment = "Rule 2 (fatha)")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u064E\u0651\u0647", label = "a-l-l-f-s-hf")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u0651\u064E\u06C1", label = "a-l-l-s-f-hgf")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u0644\u064E\u0651\u06C1", label = "a-l-l-f-s-hgf")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u06EB\u0644\u064E\u0651\u06C1", label = "a-l-M-l-s-da-hgf", comment = "Rule 2c: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, "\u0641\u0644\u0644\u064E\u0651\u06C1", label = "f-l-l-s-da-hgf", comment = "Rule 2d: non-alef")
        ftml.closeTest()
        ftml.addToTest(None, "\u0641\u0627\u0644\u0644\u064E\u0651\u06C1", label = "f-a-l-l-s-da-hgf", comment = "Rule 2d: not isolate alef")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u06EB\u0644\u0644\u064E\u0651\u06C1", label = "a-M-l-l-s-da-hgf", comment = "Rule 2d: Mark")
        ftml.closeTest()
        ftml.addToTest(None, " \u0644\u0644\u0651\u064E\u0647", label = "space-l-l-s-da-hf", comment = "Rule 2d: shouldn't match")
        ftml.closeTest()

        ftml.addToTest(None, "\u0627\u0644\u0644\u0647", label = "a-l-l-h", comment = "Rule 3")
        ftml.closeTest()
        ftml.addToTest(None, "\u0622\u0644\u0644\u0647", label = "aM-l-l-h")
        ftml.closeTest()
        ftml.addToTest(None, "\u0623\u0644\u0644\u0647", label = "aH-l-l-h")
        ftml.closeTest()
        ftml.addToTest(None, "\u0671\u0644\u0644\u0647", label = "aW-l-l-h", comment = "won't work")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u06EB\u0644\u0644\u0647", label = "a-M-l-l-h")
        ftml.closeTest()
        ftml.addToTest(None, "\u0641\u0627\u0644\u0644\u0647", label = "f-a-l-l-h", comment = "Rule 3a: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u06EB\u0644\u0647", label = "a-l-M-l-h", comment = "Rule 3d: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u200D\u0644\u0647", label = "a-l-zwj-l-h", comment = "Rule 4a: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, "\u0627\u0644\u200D\u0644\u0651\u0670\u0647", label = "a-l-zwj-l-s-da-h", comment = "Rule 4a: shouldn't match")
        ftml.closeTest()
