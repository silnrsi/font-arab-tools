...
argspec = [
    ...
    ('map', {'help': 'Feature mapping'}, {'type': 'incsv'}),
    ('-o', '--outputdir', {'help': 'Output directory', 'default': 'tests/typetuner'}, {}),
    ('--ftml', {'help': 'ftml file(s) to process', 'action': 'append'}, {}),
    ('--xslt', {'help': 'standard xslt file', 'default': '../tools/ftml.xsl'}, {'type': 'filename'}),
...
# ftml style for identifying and caching the fonts we build fonts. Rather we build a font_tag which is a the
...
def cache_font(feats, lang, norebuild):
    ...
    # lang is either None or pcp47 langtag
